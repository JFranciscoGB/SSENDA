...
document.querySelector('#botonGenerar2').addEventListener('click', generarPDF);
document.querySelector('#botonGenerar3').addEventListener('click', generarPDF);
document.querySelector('#botonAnular1').addEventListener('click', AnularCotizacion);
document.querySelector('#botonAnular2').addEventListener('click', AnularCotizacion);
document.querySelector('#botonAnular3').addEventListener('click', AnularCotizacion);
